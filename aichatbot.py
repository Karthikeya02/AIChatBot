...
label_encoder_data = {
    'classes': lbl_encoder.classes_.tolist()
}
with open('label_encoder.json', 'w') as json_file:
    json.dump(label_encoder_data, json_file)
...
def chat():
    ...
    with open('label_encoder.json', 'r') as json_file:
        label_encoder_data = json.load(json_file)
    lbl_encoder = LabelEncoder()
    lbl_encoder.classes_ = np.array(label_encoder_data['classes'])
